...
;
; 011 CLAWi+1OF1:j=i;-8:j=8*i;5,7,4:j=574*i;}
;
...
;
	...
	pop
;
; 019 CLAWchOF'c','b':str='p';'a':str='q'}
;
...
;
	...
	pop
;
; 026 FURi=-5TO15:<<CLAWiOF2:prime=i;-4,-2,0,4,6,8,10,12:even=i;-3,-1,1,3, ...
;
	iconst_5
	ineg
	putstatic	TestCase/i I
L008:
	...
	if_icmpgt	L009
;
; 027 CLAWiOF2:prime=i;-4,-2,0,4,6,8,10,12:even=i;-3,-1,1,3,5,7,9,11:CLAWi ...
;
	getstatic	TestCase/i I
	lookupswitch
	  -4: L011
...
L012:
;
; 030 CLAWiOF-3,-1,1,9:odd=i;2,3,5,7,11:prime=i;}
;
	getstatic	TestCase/i I
	lookupswitch
	  -3: L014
...
L013:
;
; 036 meowln('i = ',i,', even = ',even,', odd = ',odd,', prime = ',prime)
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
