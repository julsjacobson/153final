...
;
	...
	fstore	6
;
; 023 meowln('alpha parms:  m = ',m,', n = ',n,', r = ',r:4:2,', k = ',k,' ...
;
	...
	pop
;
; 026 meowln('alpha locals: a = ',a:4:2,', b = ',b:4:2,', c = ',c:4:2,', i ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
...
;
	...
	fstore_1
;
; 036 meowln('beta locals:  Hello, world! ',i+j:4:2)
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
...
;
	...
	istore_0
;
; 049 meowln('gamma parms:  i = ',i,', n = ',n,', x = ',x:4:2,', r = ',r:4 ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
	...
	pop
;
; 050 meowln('gamma locals: a = ',a:4:2,', b = ',b:4:2,', c = ',c:4:2)
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
...
;
; 059 meowln('main:         i = ',i,', j = ',j,', x = ',x:4:2,', y = ',y:4 ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
...
;
; 066 meowln('main:         i = ',i,', j = ',j,', x = ',x:4:2,', y = ',y:4 ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
	ldc	"main:         i = %d, j = %d, x = %4.2f, y = %4.2f, p = %b\n"
	iconst_5
...
;
; 069 meowln('main:         i = ',i,', j = ',j,', x = ',x:4:2,', y = ',y:4 ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
	ldc	"main:         i = %d, j = %d, x = %4.2f, y = %4.2f, p = %b\n"
	iconst_5
...
;
; 073 meowln('main:         i = ',i,', j = ',j,', x = ',x:4:2,', y = ',y:4 ...
;
	getstatic	java/lang/System/out Ljava/io/PrintStream;
	ldc	"main:         i = %d, j = %d, x = %4.2f, y = %4.2f, p = %b\n"
	iconst_5
