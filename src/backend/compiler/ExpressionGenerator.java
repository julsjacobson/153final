...
public class ExpressionGenerator extends CodeGenerator
{
     ...
     */
    public void emitExpression(PascatParser.ExpressionContext ctx)
    {
     ...
     */
    public void emitSimpleExpression(PascatParser.SimpleExpressionContext ctx)
    {
     ...
     */
    public void emitTerm(PascatParser.TermContext ctx)
    {
     ...
     */
    public void emitNotFactor(PascatParser.NotFactorContext ctx)
    {
     ...
     */
    public void emitLoadValue(PascatParser.VariableContext varCtx)
    {
        ...
        if (modifierCount > 0)
        {
            PascatParser.ModifierContext lastModCtx =
     ...
     */
    public Typespec emitLoadVariable(PascatParser.VariableContext varCtx)
    {
        ...
        {
            PascatParser.ModifierContext modCtx = varCtx.modifier().get(i);
    ...
    private Typespec emitLoadArrayElementAccess(
                                    PascatParser.IndexListContext indexListCtx,
                                    Typespec elmtType, boolean lastModifier)
    {
        ...
        {
            PascatParser.IndexContext indexCtx = indexListCtx.index().get(i);
    ...
    private void emitLoadRecordFieldValue(
                        PascatParser.FieldContext fieldCtx, Typespec recordType)
    {
     ...
     */
    public void emitLoadIntegerConstant(PascatParser.NumberContext intCtx)
    {
     ...
     * @parm intCtx the IntegerConstantContext.
     */
    public void emitLoadRealConstant(PascatParser.NumberContext realCtx)
    {
