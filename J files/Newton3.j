...
;
	...
	fstore_2
;
; 014 REPEATr=(x/r+r)/2;diff=r-prev;IFdiff<0diff=-diff;prev=rUNTAILdiff<1. ...
;
L001:
;
; 015 r=(x/r+r)/2
...
.var 1 is root F
;
; 027 meowln('The square root of ',n:4,' is ',root:8:4)
;
...
;
; 031 FURnumber=1TO25:<<print(number,root(number))>>
;
	iconst_1
